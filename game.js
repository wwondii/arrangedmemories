//base code all generated by Claude AI, minor tweaks and adjustments made afterward
...
loadSound('bgm',          'assets/sounds/bgm.mp3', 0.05);
loadSound('jump',         'assets/sounds/jump.mp3',               0.2);
loadSound('levelcomplete','assets/sounds/levelcomplete.mp3',      0.2);
loadSound('fail',         'assets/sounds/fail.mp3',               0.2);
...
function drawWin(){
  ...
  if(isLast){
    ...
    ctx.fillText(`level ${currentLevel+1}: ${getLevelDescription(currentLevel+1)}`, W()/2, H()/2+20);
